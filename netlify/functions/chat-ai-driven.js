...
사용자: ${message}`;
      ...
      // STEP 2: Execute action and generate final response
        ...
        if (pricingQuery) {
          deterministicReply = `AI 세미나 강연료는 1회당 50만원입니다. 시간은 1시간 30분이며, 모든 세미나가 동일한 조건입니다.`;
          searchResults = [`[세미나 정보] 강연료: 50만원 / 시간: 1시간 30분 / 총 13회 진행`];
          return {
            statusCode: 200,
            headers,
            body: JSON.stringify({
...
5. 세미나 비용/강연료 질문 → "1회당 50만원, 1시간 30분입니다"
6. 간결하고 자연스럽게 답변
